...
import { User, ClipboardList, BookOpen, PenTool, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            {/* Quote container */}
            <div className="border-l-4 border-pink-500 bg-pink-50/50 p-4 rounded-r-2xl">
              <p className="text-sm italic text-slate-700 font-medium text-justify">
...
// Inline helper for Compass rendering if needed, or import directly
